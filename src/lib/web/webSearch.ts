...
import { requestNativeWebResource, type NativeWebResourceRequest, type NativeWebResourceResponse } from "../tauri/webResource";
...
export type WebSearchTransport = (request: NativeWebResourceRequest) => Promise<NativeWebResourceResponse>;
...
export async function runCherryStyleWebSearch(
  ...
  transport: WebSearchTransport = requestNativeWebResource
...
function ensureSuccessfulResponse(response: NativeWebResourceResponse, label: string) {
